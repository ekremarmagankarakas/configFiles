...
echo -e "  ${BOLD}5.${NC} Grant Accessibility permissions: AeroSpace, Karabiner"
echo -e "  ${BOLD}6.${NC} Grant Screen Recording permission: AeroSpace (for window detection)"
echo -e "  ${BOLD}7.${NC} Launch AeroSpace and Karabiner-Elements from Applications"
echo ""
echo -e "${YELLOW}Note:${NC} Some casks (AeroSpace, Karabiner) require manual permission grants"
